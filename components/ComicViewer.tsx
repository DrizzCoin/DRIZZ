...
const ComicViewer: React.FC = () => {
  return (
    <section id="comic-viewer" style={{ marginBottom: '2em' }}>
      <h3 style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', marginTop: '1em', color: '#fff' }}>
      ...
      <div style={{ background: 'rgba(0,0,0,0.8)', border: '1px dashed #f39c12', borderRadius: '8px', maxWidth: '400px', margin: '2em auto', padding: '1em' }}>
        <p style={{ color: '#fff', fontWeight: 'bold', marginBottom: '0.5em' }}>
